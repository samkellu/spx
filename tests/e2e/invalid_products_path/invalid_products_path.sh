...
./spx_exchange "invalid_products_path.txt" "./spx_trader" &> tests/e2e/$test_name/$test_name.out
./spx_exchange "invalid_products_path.txt" "./spx_trader" &> tests/e2e/$test_name/$test_name.test
